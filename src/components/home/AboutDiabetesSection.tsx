  ...
  return (
    <SectionBand id={about.id}>
      ...
      <div className="mt-10 space-y-8">
        <div className="rounded-2xl border border-teal-100 bg-white p-6 shadow-md md:p-8">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {about.types.map((type) => (
            <div
              key={type.name}
              className="rounded-2xl border border-teal-100 bg-gradient-to-b from-white to-teal-50/40 p-6 shadow-sm"
            >
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-teal-200 bg-teal-600/5 p-6 shadow-sm md:flex-row md:items-start md:p-8">
