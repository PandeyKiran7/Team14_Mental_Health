...
/** Backend stores content managers as INTERNAL_MANAGER; list API filters CONTENT_MANAGER. */
const CONTENT_MANAGER_ROLES = new Set(["INTERNAL_MANAGER", "CONTENT_MANAGER"]);

export default function ContentManagersTable() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const all = normalizeUsers(response.data);
      setUsers(all.filter((user) => CONTENT_MANAGER_ROLES.has(user.role.toUpperCase())));
    } catch (loadError) {
